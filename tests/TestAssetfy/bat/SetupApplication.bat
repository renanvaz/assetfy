...
:: Android packaging
set AND_CERT_NAME="TestAssetfy"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TestAssetfy.p12
...
set IOS_PROVISION=cert\TestAssetfy.mobileprovision
...
set APP_ID=air.TestAssetfy

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TestAssetfy
